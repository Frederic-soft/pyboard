############
# MAX7219.py  a Micropython pyboard driver for the MAX7219 LED driver
#
...
class MAX7219:
	...
	"""
	Params:
	* bus is the SPI bus ID (1 or 2).
	  SPI buses 1/2 uses X5/Y5 for NSS (CS), X6/Y6 for SCK (CLK), X7/Y7 for MISO and X8/Y8 for MOSI (DIN).
	* baudrate is the SCK clock rate
	"""
	def __init__(self, bus, baudrate=328125):
		self.spi_bus = pyb.SPI(bus, pyb.SPI.MASTER, bits=8, firstbit=pyb.SPI.MSB, crc=None)
		if bus == 1:
