############
# HT16K334x7.py a Micropython pyboard driver for Adafruit 7-segment 4-digit 
...
class HT16K334x7:
	...
	def __init__(self, i2c_bus = 1, addr=0x70, i2c=None):
		"""
		Params:
		* i2c_bus = I2C bus ID (1 or 2), ignored if 'i2c' is provided. I2C bus 1 uses X9 and X10 for SCL and SDA, I2C bus 2 uses Y9 and Y10.
		* addr = I2C address of the display
		* i2c = initialized instance of pyb.I2C object
		"""
		self.address = addr
		...
		if i2c:
			...
			self.i2c = pyb.I2C(i2c_bus, pyb.I2C.MASTER)
	...
	def start(self):
		...
		"""
		self.send(HT16K334x7.register['sysSetup'] | HT16K334x7.clockOn)
	
	def stop(self):
		"""
		Stop the internal oscillator
		"""
		self.send(HT16K334x7.register['sysSetup'] | HT16K334x7.clockOff)
	...
	def on(self):
		...
		self.send(HT16K334x7.register['dispSetup'] | self.isOn | self.blinkMode)
	...
	def set_brightness(self, level):
		...
		if level > 15:
			level = 15
		self.send(HT16K334x7.register['dimming'] | level)
